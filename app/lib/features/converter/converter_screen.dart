        ...
        return ListView(
          ...
          children: [
            ...
            SectionCard(
              ...
              subtitle:
                  'This screen uses conversion jobs: it opens the system picker, uploads file bytes and starts a backend job.',
              child: Column(
            ...
            SectionCard(
              ...
              subtitle: controller.selectedFile == null
                  ? 'Choose a source file first. The app will then show the allowed conversion format.'
                  : 'Available directions are generated automatically from the selected file extension.',
              child: controller.availableTargets.isEmpty
                  ? const _ConverterHint(
                      text: 'No conversion directions are available yet.',
                    )
  ...
  Widget build(BuildContext context) {
    ...
    if (job == null) {
      return const SectionCard(
        ...
        subtitle:
            'After start, this area will show `queued/running/succeeded/failed` status and a link to the final file.',
      );
    }
