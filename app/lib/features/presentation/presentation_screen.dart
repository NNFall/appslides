        ...
        return ListView(
          ...
          children: [
            SectionCard(
              ...
              subtitle:
                  'This screen uses the backend API: it loads templates, builds an outline, edits it and starts a render job.',
              child: Column(
                ...
                children: [
                  TextField(
                    ...
                    decoration: const InputDecoration(
                      ...
                      hintText: 'Example: Why Mars matters for future missions',
                    ),
            ...
            SectionCard(
              ...
              subtitle: controller.hasOutline
                  ? 'You can manually edit the title and outline items before rendering.'
                  : 'Generate an outline from a topic first. Then an editable plan will appear here.',
                  ...
                  ? Column(
                      ...
                      children: [
                        ...
                        TextField(
                          ...
                          maxLines: 3,
                          decoration: const InputDecoration(
                            labelText: 'Comment for outline revision',
                            hintText:
                                'Example: focus on practical conclusions and remove the generic intro slide',
                          ),
                        ),
                        const SizedBox(height: 12),
                        OutlinedButton.icon(
                          ...
                          label: const Text('Rebuild outline'),
                        ),
                      ],
                    )
                  : const _EmptyState(
                      ...
                      text:
                          'The outline is empty. Generate an outline to open the editor.',
                    ),
            ),
            const SizedBox(height: 16),
            SectionCard(
              ...
              subtitle:
                  'Choose a template and result format. Files are not saved to the device here yet, but jobs and download URLs already work.',
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  _TemplatesStrip(
                  ...
                  SwitchListTile(
                    ...
                    subtitle: const Text(
                        'If disabled, the backend will return PPTX only.'),
  ...
  Widget build(BuildContext context) {
    ...
    if (templates.isEmpty) {
      return const _EmptyState(
        ...
        text: 'Template catalog is not loaded yet.',
      );
    }
  ...
  Widget build(BuildContext context) {
    ...
    if (job == null) {
      return const SectionCard(
        title: 'Render job',
        subtitle:
            'After start, this area will show `queued/running/succeeded/failed` status and final file links.',
      );
    }
